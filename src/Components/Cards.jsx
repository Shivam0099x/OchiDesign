function Cards() {
  return (
    <div className="w-full h-screen bg-zinc-900 px-32 border-t-[1px] border-zinc-600 mt-5 gap-5 flex items-center">
      <div className="cardcontainer w-1/2 h-[50vh]">
        <div
          className="card relative rounded-xl w-full h-full flex justify-center items-center bg-[#004D43]">
          ...
          <button className="px-2 py-1 border-2 border-zinc-300 rounded-3xl absolute left-10 bottom-10">&copy; 2019-2020</button>
          </div>
      </div>
      <div className="cardcontainer flex gap-5 w-1/2 h-[50vh]">
        <div className="card bg-[#192826] relative w-1/2 h-full flex justify-center items-center rounded-xl">
        <img src="https://ochi.design/wp-content/uploads/2022/04/logo002.svg" alt="" />
        <button className="px-3 py-1 border-2 border-zinc-300 rounded-3xl absolute left-10 bottom-10">Rating:5.0 on CLUTCH</button>
        </div>
        <div className="card bg-[#192826] relative w-1/2 flex justify-center items-center h-full rounded-xl">
        <img className="w-28 h-28" src="https://ochi.design/wp-content/uploads/2022/04/logo003.png" alt="" />
        <button className="px-2 py-1 border-2 border-zinc-300 rounded-3xl absolute left-10 bottom-10">BUSINESS BOOTCAMP ALUMNI</button>
        </div>
      </div>
    </div>
  );
